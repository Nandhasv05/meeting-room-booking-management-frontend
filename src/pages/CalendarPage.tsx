...
export function CalendarPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['calendar', range.from, range.to, hallId],
    queryFn: () =>
      unwrap<{ bookings: Cal[]; maintenance: Cal[] }>(
        api.get('/calendar', { params: { from: range.from, to: range.to, hallId: hallId || undefined } }),
      ),
