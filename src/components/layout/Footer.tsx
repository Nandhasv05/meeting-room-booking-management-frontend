...
export function Footer() {
  ...
  return (
    <footer className="flex h-11 w-full min-w-0 shrink-0 items-center justify-between gap-3 border-t border-navy-800/10 bg-white/80 px-3 backdrop-blur-md sm:px-4 md:px-5">
